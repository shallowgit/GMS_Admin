...
public interface AdminMapper {
    ...
    Integer getUserTotalCountByKeyQuery(String query_key);

    List<Gms_User> queryUserByKey(int index, int currentCount, String query_key);

    void updateUser(Gms_User gms_user);

    void addUser(Gms_User gms_user);

/*    void delUser(Gms_User gms_user);*/
    ...
    Integer getEquipmentTotalCountByKeyQuery(String query_key);

    List<Gms_Equipment> queryEquipmentByKey(int index, int currentCount, String query_key);

    void addEquipment(Gms_Equipment gms_equipment);

    void updateEquipment(Gms_Equipment gms_equipment);

    void delEquipment(Gms_Equipment gms_equipment);
    ...
    Integer getLeaseTotalCountByKeyQuery(String query_key);

    List<Gms_Equipment_Lease> queryLeaseByKey(int index, int currentCount, String query_key, String sortStatus);
    ...
    void addVdState(Gms_Vdstate vdstate);

    void delVdState(String venue_id);
}
